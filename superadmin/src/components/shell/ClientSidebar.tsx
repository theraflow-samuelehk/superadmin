...
export function ClientSidebar({ workspaceName }: { workspaceName?: string }) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "w-[260px] shrink-0 flex flex-col overflow-hidden z-50 relative",
        ...
        style={{ background: "linear-gradient(180deg, #0a1628 0%, #0e1d3a 50%, #0a1838 100%)" }}
      >
        ...
        {workspaceName && (
          <div className="relative px-4 pt-4">
            <div className="px-3 py-2.5 rounded-xl bg-white/[0.04] border border-white/[0.06]">
              <div className="text-[9px] uppercase tracking-[0.2em] text-slate-500 font-bold mb-0.5">
                Workspace
              </div>
              <div className="text-[13px] text-white font-semibold truncate">{workspaceName}</div>
            </div>
          </div>
        )}
        ...
        <div className="relative px-3 pb-3">
          ...
          >
            ...
            <p className="text-[12px] text-white/80 leading-relaxed mb-3">
              Modifica le tue pagine senza scrivere codice. Trascina, scrivi, pubblica.
            </p>
