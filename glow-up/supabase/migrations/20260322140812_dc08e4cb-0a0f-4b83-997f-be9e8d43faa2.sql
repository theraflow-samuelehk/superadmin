...
-- Update handle_new_user to seed opening hours, operator shifts, service assignments, and salon_integrations
...
DECLARE
  ...
  d int;
BEGIN
  -- Build default opening hours: 08:00-21:00 continuous, all 7 days
  v_opening_hours := '{}'::jsonb;
  FOR d IN 0..6 LOOP
  ...
  -- Create profile with email and default opening hours
  ...
  -- Create 3 default operators and collect their IDs
  v_op_ids := ARRAY[]::uuid[];
  FOR i IN 1..3 LOOP
  ...
  -- Create 6 default services and collect their IDs
  ...
  -- Create default salon_integrations with SMS and WhatsApp enabled
