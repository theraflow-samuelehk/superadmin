...
const SENDER_DOMAIN = "notify.glow-up.it"
const ROOT_DOMAIN = "glow-up.it"
const FROM_DOMAIN = "glow-up.it" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://glow-up.it"
